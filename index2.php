...
// Verifica se o tipo de membro é "admin" antes de exibir o conteúdo da página
if ($tipo === "admin") {
  // Conteúdo da página para membros admin
...
<header>
  <nav>
    <ul>
      <li><a href="login/index.php">Início</a></li>
      ...
      <li><a href="admin/iindex.php">Administração</a></li>
    </ul>
  </nav>
</header>
<section class="hero">
...
<?php
  ...
  // Conteúdo da página para membros não admin
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
